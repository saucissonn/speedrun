...
c2 = Carre2([1,7,7,1], 2)
c3 = Carre2([3, 4, 5, 4, 4, 4, 5, 4, 3], 3)
c3bis = Carre2([2,9,4,7,0,3,6,1,8], 3)
...
def test_affichage_carre():
    ...
    resultat = output.getvalue().strip()  # .strip() pour enlever les \n en trop en début/fin

    attendu = "[3, 4, 5]\n[4, 4, 4]\n[5, 4, 3]"
    assert resultat == attendu, f"Affichage incorrect :\n{resultat}"

# Appel de la fonction de test
test_affichage_carre()
